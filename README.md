...
Este projeto foi desenvolvido como um desafio proposto pelo site [devChallenges](https://devchallenges.io/) como forma de consolidação de conhecimentos na construção de páginas responsivas (nível elementar).

<!-- prettier-ignore -->
| 🪧 Vitrine Dev |     |
| ------------- | --- |
| ✨ Nome        | **Edie homepage** - devChallenges |
| 🏷️ Tecnologias | HTML, Sass, JavaScript, Gulp |
| 🚀 URL Front-end | [**Acesse o site**](https://araujowebdev.github.io/Edie-homepage---devChallenges/) ou veja como rodar localmente no item [**⚙️ Como usar**](#howto) |
| 🔥 Desafio     | [devChallenges - Edie homepage](https://devchallenges.io/challenges/xobQBuf8zWWmiYMIAZe0) |

![](https://raw.githubusercontent.com/araujowebdev/Edie-homepage---devChallenges/main/dist/assets/imgs/page-view-edie.jpg)
...
```
git clone https://github.com/araujowebdev/Edie-homepage---devChallenges.git
```
...
```
[00:00:00] Using gulpfile ~/Edie-homepage---devChallenges/gulpfile.js
